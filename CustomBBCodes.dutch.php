<?php
/**********************************************************************************
* CustomBBCode.Dutch.php - Custom BBCode Manager mod Dutch language file
*********************************************************************************
...
$txt['Edit_text'] = 'De HTML gebruikt voor de tag:';
...
$txt['Edit_Upload_description'] = 'U kunt Uw nieuwe BBCode laten weergeven met een knop in de Editor. Dit moet een .GIF afbeelding zijn van 23x22px met een transparante achtergrond. Het mag een animati zijn. Maximale groote is 10kb.<div class="smalltext"> Afbeelding type en groote mogen niet afwijken.  Afbeelding px formaat is vrij maar zijn aanbevolen voor het beste resultaat.</div>';
$txt['Edit_Upload_invalid_upload'] = 'Uw knop moet een .GIF afbeelding zijn met een maximun groote van 10kb.';
$txt['Edit_Upload_error'] = 'Foutmelding tijdens uploaden van het bestand.';
